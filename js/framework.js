...
var Animation = function(width, height,row, column, limit, imgSrc, fps, columns,rows)
{
	if(fps==null || fps>=33)
		this.fps=1
	else
	...
	this.Update=function()
	{
		...
		if(this.columns==null || this.columns==0)
			this.columns= this.image.width/this.image.width
		if(this.rows==null || this.rows==0)
			this.rows=this.image.height/this.image.height
	}
	...
	this.Draw = function(ctx)
	{
		...
		ctx.drawImage(this.image, this.cropPosition.x, this.cropPosition.y, 
